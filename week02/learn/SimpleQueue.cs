public class SimpleQueue {
    public static void Run() {
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue isn't working correctly. Output was in the wrong order.
        ...
        // Defect(s) Found: This code fails to run at Dequeue. It throws an error
    }
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // Was _queue.Insert(0, value); // Original code didn't work
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // Was index 1, and that failed. Needed to be index 0
        _queue.RemoveAt(0); // Same as above line's comment
        return value;
    }
}